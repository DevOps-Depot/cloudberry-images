...
def test_packages_installed(host):
    ...
    packages = [ "git", "vim-common", "tmux", "wget",
                 "the_silver_searcher", "htop", "apr-devel",
                 ...
                 "pam-devel", "passwd", "perl-ExtUtils-Embed",
                 "perl-Test-Simple", "pinentry", "python36-devel",
                 "readline-devel", "rpm-build", "rpm-sign",
                 "rpmdevtools", "rsync", "sudo", "tar", "unzip",
                 "util-linux", "which", "zlib-devel", "libuv-devel",
                 "libyaml-devel", "perl-IPC-Run" ]
